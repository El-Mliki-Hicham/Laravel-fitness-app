		...
		<div class="header-menu">
			<div class="container">
				<div class="header-logo">
					<a href="index.html" class="logo"><img src="assets/img/logo-2.svg" alt="logo"></a>
				</div>
				<nav class="nav-menu">
					<ul class="nav-list">
						<li class="dropdown">
							...
							<ul>
								...
								<li class="menu-active"><a href="home-fitness.html">Fitness</a></li>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-3 footer-item-logo">
					<a href="index.html" class="logo-footer"><img src="assets/img/logo-2.svg" alt="logo"></a>
				</div>
