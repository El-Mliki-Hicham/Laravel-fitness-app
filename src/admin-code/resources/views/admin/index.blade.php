    ...
    <div class="row">
        ...
        <div class="activeMode col-lg-12">
            <div class="card">
                ...
                <a href="{{route("admin.create")}}" class="btn btn-info">Ajouter</a>
            </div>
        </div>
                ...
                <div class="card">
                    ...
                    <div class="user">
                        ...
                        <div class="item-actions">
                            <a href="edit.html"><i class="item-action fa fa-edit" data-toggle="modal"
        ...
        <div class="col-lg-6">
            <div class="users">
                <div class="card">
                    ...
                    <div class="user">
                        {{-- {{asset('assets/img/$value->photo')}} --}}
                        <div class="uImg"><img src="{{ asset('assets/img')}}/{{ ($value->photo) }}" alt=""></div>
                        <div class="info">
                ...
                <div class="users">
                    <div class="card">
                        ...
                        <div class="user">
                            ...
                            <form action="{{route('categorie.destroy',$value->id_categorie)}}" method="POST">
                                ...
                                <div class="item-actions">
                                    ...
                                    <button class="btn btn-link"><a href=""> <i class="item-action fa fa-trash"
                                                data-toggle="modal" data-target="#deleteItemModal"></i></a></button>
                                </div>
                                @method('DELETE')
                            </form>
                        </div>
